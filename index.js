...
const fetchAndSendCourses = async () => {
  try {
    ...
    for (const course of courses) {
      if (!sentCourses.has(course.url)) {
        sentCourses.add(course.url);

        // Send the course immediately
    ...
    console.error("❌ Error fetching and sending courses:", err);
  }
};
